...
<body
    ...
    <h1 class="mb-4 text-center text-3xl font-bold text-white">Welcome to Master Data Management System (MDM) </h1>
    <p class="mb-4 text-white">A simple application for gateonesoft.lk </p>
